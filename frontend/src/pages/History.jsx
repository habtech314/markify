...
function getExt(f) {
  return EXT_MAP[f.split(".").pop().toLowerCase()] || "FILE";
}
...
export default function History({ navigate, history }) {
  ...
  const handleDownload = () => {
    const b = new Blob([selected.markdown], { type: "text/markdown" });
      ...
      <div className="history-page page">
        <div className="history-detail">
          ...
          <div className="history-detail-body">
            <textarea className="detail-textarea" readOnly value={selected.markdown} />
          </div>
        </div>
      </div>
    );
        ...
        {history.length === 0 ? (
          <div className="history-empty">
            ...
            <p className="history-empty-sub">
              Go convert a file and it&apos;ll appear here.
            </p>
            <button
